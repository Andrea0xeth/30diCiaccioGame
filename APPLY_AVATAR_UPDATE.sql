-- ============================================
-- AGGIORNAMENTO FUNZIONE PER SUPPORTARE AVATAR
-- ============================================
-- Esegui questo script nella Supabase SQL Editor:
-- https://supabase.com/dashboard/project/[PROJECT-REF]/sql/new
--
-- Questo aggiorna la funzione insert_user_with_passkey per accettare
-- il parametro p_avatar e salvare l'URL della foto profilo nel database.
