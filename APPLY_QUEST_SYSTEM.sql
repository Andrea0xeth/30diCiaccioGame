-- ============================================
-- APPLICA IL SISTEMA DI QUEST PER UTENTE
-- ============================================
-- Esegui questo script nella Supabase SQL Editor:
-- https://supabase.com/dashboard/project/[PROJECT-REF]/sql/new
--
-- Questo script:
-- 1. Crea 100 quest diverse
-- 2. Crea la tabella per le assegnazioni
-- 3. Crea le funzioni per assegnare e recuperare le quest

-- IMPORTANTE: Esegui prima 00010_create_100_quests.sql, poi questo file
